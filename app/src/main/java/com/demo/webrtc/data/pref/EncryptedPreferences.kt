...
open class EncryptedPreferences(val context: Context) {
    ...
    protected fun getIntIndex(key: String) = iSharedPrefs.getInt(key, -1)
    protected fun getIntProfessionIndex(key: String) = iSharedPrefs.getInt(key, -1)
    //endregion

    protected fun getIntDressingIndex(key: String) = iSharedPrefs.getInt(key, -1)
    protected fun getIntLanguageIndex(key: String?) = iSharedPrefs.getInt(key, -1)
